# Soundsphere Dev Guide

This file outlines the process of setting up a local dev environment for Soundsphere.
...
```bash
git clone https://github.com/Hud-sonn/soundsphere.git
cd Soundsphere
