package com.soundsphere.paxsenix

import android.content.Context
import com.soundsphere.music.betterlyrics.TTMLParser
import com.soundsphere.paxsenix.models.AppleMusicSearchResponse
import com.soundsphere.paxsenix.models.LyricsResponse

import com.soundsphere.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Soundsphere/$appVersion")
                }
