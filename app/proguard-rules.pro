...
# Since Soundsphere is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.soundsphere.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.soundsphere.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.soundsphere.music.utils.cipher.** { *; }
-keep class com.soundsphere.music.utils.potoken.** { *; }
...
-keep class com.soundsphere.music.models.PersistQueue { *; }
-keep class com.soundsphere.music.models.PersistPlayerState { *; }
-keep class com.soundsphere.music.models.QueueData { *; }
-keep class com.soundsphere.music.models.QueueType { *; }
-keep class com.soundsphere.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.soundsphere.music.cast.** { *; }
...
-keep class com.soundsphere.music.recognition.VibraSignature { *; }
-keepclassmembers class com.soundsphere.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.soundsphere.music.listentogether.proto.** { *; }
-keepclassmembers class com.soundsphere.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.soundsphere.shazamkit.models.** { *; }
-keepclassmembers class com.soundsphere.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.soundsphere.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.soundsphere.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.soundsphere.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
