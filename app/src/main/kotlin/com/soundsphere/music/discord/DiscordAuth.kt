package com.soundsphere.music.discord
...
import com.soundsphere.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.soundsphere.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.soundsphere.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "soundspherediscord://oauth2/callback"
