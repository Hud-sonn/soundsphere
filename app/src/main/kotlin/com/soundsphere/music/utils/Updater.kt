...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/Hud-sonn/soundsphere"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Soundsphere.apk" -> "universal" to "foss"
                name == "Soundsphere-with-Google-Cast.apk" -> "universal" to "gms"
