...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.soundsphere.music.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.soundsphere.music.widget.playlists.UPDATE_WIDGET"
