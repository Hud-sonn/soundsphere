...
package com.soundsphere.music.widget
...
import com.soundsphere.music.recognition.MusicRecognitionService
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.soundsphere.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.soundsphere.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.soundsphere.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.soundsphere.music.widget.recognizer.RESET"
    }
}
