...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.soundsphere.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.soundsphere.music.widget.LIKE"
        const val ACTION_NEXT = "com.soundsphere.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.soundsphere.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.soundsphere.music.widget.UPDATE_WIDGET"
    }
}
