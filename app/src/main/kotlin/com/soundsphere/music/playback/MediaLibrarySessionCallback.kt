...
import com.soundsphere.innertube.models.filterVideoSongs
import com.soundsphere.music.R
import com.soundsphere.music.constants.AndroidAutoSearchLocalLimitKey
...
import com.soundsphere.music.constants.AndroidAutoSectionsOrderKey
import com.soundsphere.music.constants.AndroidAutoYouTubePlaylistsKey
import com.soundsphere.music.ui.screens.settings.AndroidAutoSection
import com.soundsphere.music.ui.screens.settings.deserializeSections
import com.soundsphere.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.soundsphere.innertube.pages.HomePage.Section>()
