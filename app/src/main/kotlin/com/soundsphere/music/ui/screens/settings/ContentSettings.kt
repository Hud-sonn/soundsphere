...
import com.soundsphere.music.constants.ContentCountryKey
import com.soundsphere.music.constants.ContentLanguageKey
import com.soundsphere.music.constants.CountryCodeToName
import com.soundsphere.music.constants.EnableBetterLyricsKey
import com.soundsphere.music.constants.EnableKugouKey
import com.soundsphere.music.constants.EnableLrcLibKey
import com.soundsphere.music.constants.EnablePaxsenixKey
import com.soundsphere.music.constants.EnableLyricsPlus
import com.soundsphere.music.constants.EnableSimpMusicKey
...
import com.soundsphere.music.constants.HideYoutubeShortsKey
import com.soundsphere.music.constants.LanguageCodeToName
import com.soundsphere.music.constants.LyricsProviderOrderKey
import com.soundsphere.music.constants.ProxyEnabledKey
import com.soundsphere.music.constants.ProxyPasswordKey
import com.soundsphere.music.constants.ProxyTypeKey
import com.soundsphere.music.constants.ProxyUrlKey
import com.soundsphere.music.constants.ProxyUsernameKey
import com.soundsphere.music.constants.QuickPicks
...
import com.soundsphere.music.constants.ShowArtistDescriptionKey
import com.soundsphere.music.constants.ShowMostStatsPlaylistsKey
import com.soundsphere.music.constants.ShowArtistSubscriberCountKey
import com.soundsphere.music.constants.ShowMonthlyListenersKey
import com.soundsphere.music.constants.ShowWrappedCardKey
import com.soundsphere.music.constants.TopSize
...
import com.soundsphere.music.ui.component.DraggableLyricsProviderItem
import com.soundsphere.music.ui.component.DraggableLyricsProviderList
...
fun ContentSettings(
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.soundsphere.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.soundsphere.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.soundsphere.music.db.entities.PlaylistEntity(
                        id = com.soundsphere.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.soundsphere.music.db.entities.PlaylistEntity(
                        id = com.soundsphere.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
                ...
                Column(
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Text(stringResource(R.string.enable_unison))
                            Text(
                                text = stringResource(R.string.enable_unison_desc),
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                        }
    ...
    if (showProviderPriorityDialog) {
        ...
        LaunchedEffect(normalizedOrder, enableLrclib, enableKugou, enableBetterLyrics, enablePaxsenix, enableLyricsPlus, enableSimpMusic, enableUnison) {
